...
def solution(dimensions, your_position, guard_position, distance):
 ...
 {y_dim}|                                  |                                  |                                  |
  ...
  (0, 0)o--------------{x_dim}-------------o----------------------------------o----------------------------------o
    ...
    path_mat = dict()
    self_slope_set = set()
    enermy_slope_set = set()
    compute_shoot_angle(dimensions, your_position, guard_position, 0, 0, 
    ...
    return len(enermy_slope_set - self_slope_set)
...
def compute_shoot_angle(
    ...
    for direction_x, direction_y in [
        ...
        compute_shoot_angle(
            dimensions, 
            orig_self, orig_enermy, 
            x_offset+direction_x, 
            y_offset+direction_y, 
            path_mat, 
            distance, 
            self_slope_set, enermy_slope_set)
...
def main():
    ...
    #guard_position = [2,3]
    #distance = 100
    ##choices = solution([300,275], [150,150], [185,100], 500)
    #init_image(dimensions, your_position, distance)
    #choices = solution(dimensions, your_position, guard_position, distance)
    #plt.grid(linestyle='dotted')
    #plt.show()
